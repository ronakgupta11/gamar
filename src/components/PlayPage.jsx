  ...
  return (
    <>
      {/* <Image src={"/border.png"} width={199} height={199} /> */}
        <Image src="/joystickNew.png" width={150} height={30} className="  brightness-75 absolute bottom-0 ml-56  z-20" />
        <Image src="/joystickNew.png" width={150} height={30} className="  absolute bottom-0  brightness-75 select-none touch-none none  right-0 mr-56  z-20" />
      <div className="w-full h-screen  rounded-lg bg-slate-950 bg-clip-padding -z-20">

      <div className="absolute m-auto left-0 right-0 top-14 h-[40rem] w-[50rem] rounded-3xl bg-slate-950 bg-clip-padding z-10">
